    ...
    public class QuirkHandler : ModPlayer
    {
        ...
        public string GetQuirkDescription(QuirkType quirk)
        {
            ...
            string desc = quirk switch
            {
                ...
                QuirkType.OneForAll8th => "Bring forth the Stockpiled power of your predecessors, enhancing your body.",
                QuirkType.Explosion => "Use normal Skills to build up sweat, light it up powering up your moves.",
                QuirkType.SuperRegeneration => "Rapidly heal physical damage, though it places heavy strain on your body.",
                QuirkType.HalfColdHalfHot => "use powerfull Ice Skills, ignite yourself to use devastating fire moves.",
                ...
                QuirkType.Blueflame => "Generate blue flames that burn hotter than normal fire, be carefull to not cremate yourself.",
                QuirkType.HellFlames => "Generate hellfire that burns hotter than normal fire.",
                QuirkType.Engine => "Build up momentum while moving at high speeds, allowing for powerfull kicks",
                QuirkType.OpticBlast => "Emit a powerful beam of energy from your eyes, close them or wear glasses.",
