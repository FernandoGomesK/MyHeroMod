...
{
    public class OverclockLayer : PlayerDrawLayer
    {
        ...
        {
            var overclockPlayer = drawInfo.drawPlayer.GetModPlayer<OverclockPlayer>();
            return overclockPlayer.isOverclockBuffActive && !drawInfo.drawPlayer.dead;
