...
// public class FaJinLayer : PlayerDrawLayer
// {
    
//     public override Position GetDefaultPosition() => new AfterParent(PlayerDrawLayers.ArmOverItem);

//     public override bool GetDefaultVisibility(PlayerDrawSet drawInfo) {
//         var faJinPlayer = drawInfo.drawPlayer.GetModPlayer<FaJinPlayer>();
//         return  faJinPlayer.FaJinStored;
//     }

//     protected override void Draw(ref PlayerDrawSet drawInfo) {
        
//         if (!ModContent.HasAsset("MyHeroMod/Assets/FaJinEffect")) {
//             return; 
//         }

//         Texture2D texture = ModContent.Request<Texture2D>("MyHeroMod/Assets/FaJinEffect").Value;
