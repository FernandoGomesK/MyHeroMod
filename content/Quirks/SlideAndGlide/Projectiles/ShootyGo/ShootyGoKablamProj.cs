...
{
    public class ShootyGoKablamProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.MagicMirror, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 100, default, 1.5f);
            }
