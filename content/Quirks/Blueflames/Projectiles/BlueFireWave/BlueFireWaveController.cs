...
namespace MyHeroMod.content.Quirks.Blueflames.Projectiles.BlueFireWave
{
    public class BlueFireWaveController : ModProjectile
    {
            ...
            if (Projectile.timeLeft % 3 == 0)
            {
                ...
                if (foundGround)
                {
                    ...
                    Projectile.NewProjectile(
                        ...
                        ModContent.ProjectileType<BlueFireWaveProj>(),
                        Projectile.damage,
