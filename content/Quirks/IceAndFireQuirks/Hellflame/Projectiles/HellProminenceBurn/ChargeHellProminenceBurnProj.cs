...
{ 
    public class ChargeHellProminenceBurnProj : BaseChannelingProj
    {
        ...
        {
            SoundEngine.PlaySound(new SoundStyle("MyHeroMod/Assets/Sounds/CremationSound") { Volume = 1.5f, Pitch = -0.8f }, player.position);
            ...
            Projectile.NewProjectile(
                ...
                player.Center,
                Vector2.Zero, 
                ModContent.ProjectileType<HellProminenceBurnController>(),
                Projectile.damage, 
                2f, 
                player.whoAmI,
                120f
