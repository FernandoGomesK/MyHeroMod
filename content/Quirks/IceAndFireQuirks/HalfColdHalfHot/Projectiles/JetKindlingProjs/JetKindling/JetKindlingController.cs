...
// {
//     public class JetKindlingController : BaseLaserProj
//     {
...
//         protected int ParticleType => ModContent.ProjectileType<HellJetBurnEffectProj>();
...
//                 Dust origin = Dust.NewDustPerfect(startPoint + handOffset + Main.rand.NextVector2Circular(30f, 30f), DustID.Torch, Projectile.velocity * 30f, 0, default, 3.5f);
...
//                 Dust coreDust = Dust.NewDustPerfect(corePos, DustID.RedTorch, Projectile.velocity * Main.rand.NextFloat(35f, 45f), 0, default, 2.8f);
...
//                 Dust blueDust = Dust.NewDustPerfect(outerPos, DustID.Torch, Vector2.Zero, 100, default, 3.5f);
...
//                 Dust spark = Dust.NewDustPerfect(sparkPos, DustID.FireworkFountain_Red, Vector2.Zero, 0, default, 1.5f);
