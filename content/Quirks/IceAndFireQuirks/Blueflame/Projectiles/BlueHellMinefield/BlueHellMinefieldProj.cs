...
namespace MyHeroMod.content.Quirks.IceAndFireQuirks.Blueflameflame.Projectiles
{
public class BlueHellMinefieldTrap : BaseTrapProj
{
    ...
    protected override void SpawnTrapVisuals()
    {
        ...
        if (Main.rand.NextBool(3))
        {
            ...
            Dust fire = Dust.NewDustPerfect(dustPos, DustID.BlueTorch, new Vector2(0, -Main.rand.NextFloat(1f, 3f)));
            fire.noGravity = true;
            fire.scale = 1.5f;
        }
    }
