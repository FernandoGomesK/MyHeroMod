       ...
       protected override void SpawnBeamDust(Player player)
{
    ...
    for (int i = 0; i < 5; i++) 
    {
        ...
        Dust origin = Dust.NewDustPerfect(startPoint + handOffset + Main.rand.NextVector2Circular(80f, 80f), DustID.BlueTorch, Projectile.velocity * 30f, 0, default, 5.5f);
    ...
    for (int i = 0; i < 5; i++) 
    {
        ...
        Dust coreDust = Dust.NewDustPerfect(corePos, DustID.IceTorch, Projectile.velocity * Main.rand.NextFloat(35f, 45f), 0, default, 6.8f);
    ...
    for (int i = 0; i < 10; i++) 
    {
        ...
        Dust blueDust = Dust.NewDustPerfect(outerPos, DustID.BlueTorch, Vector2.Zero, 100, default, 6.5f);
    ...
    if (Main.rand.NextBool(2))
    {
        ...
        Dust spark = Dust.NewDustPerfect(sparkPos, DustID.FireworkFountain_Blue, Vector2.Zero, 0, default, 8.5f);
