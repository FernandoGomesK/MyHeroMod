...
public class ReciproSpinDiveSkill : QuirkBaseSkill
{
    ...
    public override void OnUse(Player player)
    {
        ...
        string attackName = "Recipro Spin Dive!";
        ...
        */
        ...
        if (player.HasBuff(ModContent.BuffType<ReciproBuff>()))
        {
            ...
            attackName = "Recipro Spin Dive: BURST!"; 
        }
        ...
        Projectile.NewProjectile(
            ...
            player.Center,
            Vector2.Zero, 
            ModContent.ProjectileType<ReciproSpinDiveController>(),
            FinalDamage, 
            10f, 
            player.whoAmI
        );
