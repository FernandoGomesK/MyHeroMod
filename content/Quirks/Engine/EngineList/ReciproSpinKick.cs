...
public class ReciproSpinSkill : QuirkBaseSkill
{
    ...
    public override string IconPath => "MyHeroMod/Assets/SkillIcons/Engine/EngineWheelIcon";
    ...
    public override void OnUse(Player player)
    {
        ...
        string attackName = "Recipro Spin!";
        ...
        */
        ...
        Projectile.NewProjectile(
            ...
            player.Center,
            Vector2.Zero, 
            ModContent.ProjectileType<ReciproSpinController>(),
            FinalDamage, 
            10f, 
            player.whoAmI
        );
