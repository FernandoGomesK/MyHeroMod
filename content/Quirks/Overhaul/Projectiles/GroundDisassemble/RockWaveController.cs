...
namespace MyHeroMod.content.Quirks.Overhaul.Projectiles.GroundDisassemble
{
    public class RockWaveController : ModProjectile
    {
            ...
            if (Projectile.timeLeft % 3 == 0)
            {
                ...
                if (foundGround)
                {
                    ...
                    Projectile.NewProjectile(
                        ...
                        ModContent.ProjectileType<RockSpikeProj>(),
                        Projectile.damage,
