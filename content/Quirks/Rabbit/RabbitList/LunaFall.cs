...
{
    public override string Name => "Luna Fall";
    public override string Description => "A Falling Kick";
    public override string IconPath => "MyHeroMod/Assets/Skills/LunaFall"; 
    ...
    public override void OnUse(Player player)
    {
        ...
        Projectile.NewProjectile(
            ...
            player.Center,
            Vector2.Zero, 
            ModContent.ProjectileType<LunaFallController>(),
            FinalDamage, 
            10f, 
            player.whoAmI
        );
