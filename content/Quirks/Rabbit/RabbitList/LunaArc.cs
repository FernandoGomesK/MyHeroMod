...
public class LunaArcSkill : QuirkBaseSkill
{
    public override string Name => "Luna Arc";
    public override string Description => "A Arcing Kick";
    public override string IconPath => "MyHeroMod/Assets/Skills/LunaArc"; 
    ...
    public override void OnUse(Player player)
    {
        ...
        Projectile.NewProjectile(
            ...
            player.Center,
            Vector2.Zero, 
            ModContent.ProjectileType<LunaArcController>(),
            FinalDamage, 
            10f, 
            player.whoAmI
        );
