...
public class ToggleRagnarokSkill : QuirkBaseSkill
{
    public override string Name => "Toggle Dark Shadow";
    public override string Description => "Summon DarkShadow.";
    public override string IconPath => "MyHeroMod/Assets/SkillIcons/Darkshadow/DarkshadowIcon";
    ...
    public override void OnUse(Player player)
    {
        ...
        if (player.HasBuff(ModContent.BuffType<RagnarokBuff>()))
        {
            player.ClearBuff(ModContent.BuffType<RagnarokBuff>());
        ...
        else
        {
            ...
            player.AddBuff(ModContent.BuffType<RagnarokBuff>(), 360000);
