...
namespace MyHeroMod.content.Quirks.OFA9th.Projectiles.BlackWhip
{
    ...
    public class BlackWhipProjectile : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            string chainTexturePath = "MyHeroMod/content/Quirks/OFA9th/Projectiles/BlackWhip/BlackWhipChain";
